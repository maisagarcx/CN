minimo1 = [0.1 0.1 0.1]; % mínimo local
% segundo o Joselias, plota o gráfico e espitualiza a reposta
tolerancia1 = 0.05;
n1 = 3; % números de variáveis
iterMAX1 = 10;

[aproximacao,gNew,~] = metGradienteDescendente(n1, minimo1, tolerancia1, iterMAX1);
%aproximacao = [0.10251921584124164724846158739186, -0.11967786050292097079129821563958, 0.075466196327028590414204970851599];
...
function [aproximacao,gNew,k] = metGradienteDescendente(~, minimo, tolerancia, iterMAX)
    ...
    syms f2(x1,x2,x3);
    f2(x1,x2,x3) = cos(x3 - x2)^2 - 8*x2 + 1;
